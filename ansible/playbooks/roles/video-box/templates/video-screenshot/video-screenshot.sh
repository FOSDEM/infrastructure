...
while true; do
	...
	ffmpeg -i tcp://localhost:8898/?timeout=10000 -vf scale=160:-1 -qscale:v 20 -vframes 1 -y ${SCREENSHOT_PATH}.$$.jpg 2>> /dev/null && mv ${SCREENSHOT_PATH}.$$ ${SCREENSHOT_PATH}.jpg
